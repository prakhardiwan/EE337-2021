...
void main(void)
{
  ...
  lcd_init();
	...
	while(1)
	{
		...
		temperature = (x/((0.01/3.3)*1024)); 															//NOTE: LM35 O/P: 10mV/°C, Refer to LM35 datasheet for more information
	

x = (unsigned int) (temperature*10);							//Convert float value to unsigned int : retaining 1 value after decimal 
